...
def test_discord_webhook():
    ...
    print(f"✅ Found {len(webhooks)} Discord webhook(s)")
    ...
    for webhook in webhooks:
        ...
        for platform in platforms:
            print(f"\n   📤 Sending test notification for {platform.upper()}...")
            ...
            if success:
                print(f"   ✅ Successfully sent {platform.upper()} notification!")
            else:
                print(f"   ❌ Failed to send {platform.upper()} notification")
