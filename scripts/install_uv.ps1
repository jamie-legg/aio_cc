...
param (
    ...
    [string]$ArtifactDownloadUrl = 'https://github.com/astral-sh/uv/releases/download/0.9.0',
...
if ($env:UV_DOWNLOAD_URL) {
  ...
  $ArtifactDownloadUrl = "$installer_base_url/astral-sh/uv/releases/download/0.9.0"
}
$auth_token = $env:UV_GITHUB_TOKEN

$receipt = @"
{"binaries":["CARGO_DIST_BINS"],"binary_aliases":{},"cdylibs":["CARGO_DIST_DYLIBS"],"cstaticlibs":["CARGO_DIST_STATICLIBS"],"install_layout":"unspecified","install_prefix":"AXO_INSTALL_PREFIX","modify_path":true,"provider":{"source":"cargo-dist","version":"0.30.0"},"source":{"app_name":"uv","name":"uv","owner":"astral-sh","release_type":"github"},"version":"0.9.0"}
"@
